...
test: main.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memchr.o ft_memcmp.o ft_strlen.o ft_strchr.o ft_isalnum.o ft_isalpha.o ft_isdigit.o ft_strnstr.o ft_strncmp.o ft_isascii.o ft_isprint.o ft_toupper.o ft_tolower.o ft_strrchr.o ft_atoi.o ft_strlcpy.o ft_strlcat.o
	$(COMPIL) -o test main.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c ft_memmove.c ft_memchr.c ft_memcmp.c ft_strlen.c ft_strchr.c ft_isalnum.c ft_isalpha.c ft_isdigit.c ft_strnstr.c ft_strncmp.c ft_isascii.c ft_isprint.c ft_toupper.c ft_tolower.c ft_strrchr.c ft_atoi.c ft_strlcpy.c ft_strlcat.c
	rm -rf *.o
clean: 
	rm -rf test *.o 
